...
public class VrPlayerSoundEffectController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        VrPlayerEntityController playerEntityController = GetComponent<VrPlayerEntityController>();
        ...
        GetComponent<VrPlayerDNALevel>().OncurrentEvolutionLevelChanged += UpdateCurrentLevel;
